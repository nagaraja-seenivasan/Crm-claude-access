...
export type ConditionOperator = 'equals' | 'not_equals' | 'greater_than' | 'less_than' | 'greater_than_or_equal' | 'less_than_or_equal' | 'contains' | 'starts_with' | 'ends_with' | 'is_null' | 'is_not_null';
...
export type NodeData = TriggerNodeData | ConditionNodeData | SetValueNodeData | NotificationNodeData | Record<string, unknown>;
